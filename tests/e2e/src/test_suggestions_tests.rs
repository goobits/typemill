//! Suggestions for tests analysis
//!
//! Tests actionable suggestions generated for tests analysis.
...
#[tokio::test]
async fn test_tests_analysis_generates_suggestions_for_coverage() {
...
"#;
    ...
    let result = analyze_tests(&workspace, &mut client, "coverage", "test_file.ts").await;
