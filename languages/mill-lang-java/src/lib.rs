...
impl mill_plugin_api::AnalysisMetadata for JavaPlugin {
    fn test_patterns(&self) -> Vec<Regex> {
        vec![
            ...
            Regex::new(r"@ParameterizedTest").unwrap(),
            Regex::new(r"@RepeatedTest").unwrap(),
        ]
    }

    fn assertion_patterns(&self) -> Vec<Regex> {
        vec![
            Regex::new(r"\bassert\b").unwrap(),
            Regex::new(r"assertEquals").unwrap(),
            Regex::new(r"assertTrue").unwrap(),
            Regex::new(r"assertThat").unwrap(),
        ]
    }
